...
import { ActionImageGallery } from "./action-image-gallery";
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-nav">
      ...
      <main className="p-4 space-y-4">
        ...
        <ActionImageGallery
          title={t("actions.view.beforePhotos")}
          images={beforeImages}
          onUploadClick={() => triggerFileUpload("BEFORE")}
          isUploading={uploadImage.isPending}
          onDeleteImage={handleDeleteImage}
          emptyMessage={t("actions.view.noPhotos")}
          imageAlt={t("actions.view.beforeCaption")}
        />

        <ActionImageGallery
          title={t("actions.view.afterPhotos")}
          images={afterImages}
          onUploadClick={() => triggerFileUpload("AFTER")}
          isUploading={uploadImage.isPending}
          onDeleteImage={handleDeleteImage}
          emptyMessage={t("actions.view.noPhotos")}
          imageAlt={t("actions.view.afterCaption")}
        />
        <input
          type="file"
          accept="image/*"
